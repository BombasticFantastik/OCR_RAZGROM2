...
create_sans_images(alphabet,'white.png',3,2500)
create_sans_images(alphabet,'white.png',5,2500)
create_sans_images(alphabet,'white.png',6,2500)
create_sans_images(alphabet,'white.png',8,2500)
